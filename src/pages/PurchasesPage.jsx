                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                  {form.items.map((item, i) => (
                    <tr key={i}>
                      ...
                      <td className="px-3 py-2">
                        <input type="number" step="0.01" min="0" inputMode="decimal" value={item.unitPrice} onChange={(e) => updateItem(i, 'unitPrice', Number(e.target.value))} className="w-28 ml-auto text-right text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 px-2 py-1" />
                      </td>
